...
- 当 $\pmb\theta$ 和 $\sigma^2$ 皆未知时二者的后验分布
    ...
    其中 $\displaystyle\overline{A}_{n}=\sum_{i=1}^n(\pmb x_i-\overline{\pmb x})^\text{T}(\pmb x_i-\overline{\pmb x})$.
...
- 当 $\pmb\theta$ 和 $\sigma^2$ 皆未知时二者的共轭后验分布
    ...
    其中 $\displaystyle\overline{A}_n=\sum_{i=1}^n(\pmb x_i-\overline{\pmb x})^{\text{T}}(\pmb x_i-\overline{\pmb x})$.
